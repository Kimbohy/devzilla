...
const Entraide = () => {
  return (
    <div className="flex w-screen h-screen flex-col justify-center items-center gap-8 md:flex-row md:gap-0 md:justify-between bg-[url('../public/entraide.jpg')] bg-cover bg-center ">
      <div className="w-full md:w-1/2 md:h-full flex flex-col gap-12 px-6 md:px-0 md:justify-center md:items-center">
